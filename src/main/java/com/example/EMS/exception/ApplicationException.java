...
public class ApplicationException {
    ...
    @ExceptionHandler(PropertyValueException.class)//whenever this exception occur then this annotation tells to springboot to redirect to this method
    public ResponseEntity<String> entityExistsException(PropertyValueException ex){
        return new ResponseEntity<>("property is missing", HttpStatus.INTERNAL_SERVER_ERROR);
    }
